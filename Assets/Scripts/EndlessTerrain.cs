...
public class EndlessTerrain : MonoBehaviour {
    ...
    const float SqViewerMoveThresholdForChunkUpdate = viewerMoveThresholdForChunkUpdate * viewerMoveThresholdForChunkUpdate;
    ...
    void Update()
    {
        ...
        if ((viewerPositionOld - viewerPosition).sqrMagnitude > SqViewerMoveThresholdForChunkUpdate)
        {
